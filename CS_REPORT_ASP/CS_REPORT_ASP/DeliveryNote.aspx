<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DeliveryNote.aspx.vb" Inherits="CS_REPORT_ASP.DeliveryNote" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="section-title">Delivery Note Data</div>

<div style="margin-top: 20px; text-align: right;">
    <strong>Search: </strong>
    <asp:TextBox ID="txtDNSearch" runat="server" CssClass="form-control green" 
                 style="width: 300px; display: inline-block;" placeholder="DNSearch"></asp:TextBox>
    ...
    <asp:Button ID="btnEdit" runat="server" CssClass="btn" Text="Edit" OnClick="btnEdit_Click" />
            ...
            <table class="detail-table">
                <tr>
                    ...
                    <td><asp:TextBox ID="txtDeliveryNoteNo" runat="server" CssClass="input-text" /></td>
                    <td>DATE:</td>
